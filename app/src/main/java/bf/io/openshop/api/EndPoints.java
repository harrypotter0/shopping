...
public class EndPoints {
    ...
    public static final String  SHOPS                    = "https://private-3ea2b7-vamsi6.apiary-mock.com/citys";
    public static final String SHOPS_SINGLE             = API_URL.concat(CONST.ORGANIZATION_ID + "/shops/%d");
    public static final String NAVIGATION_DRAWER        = "https://private-3ea2b7-vamsi6.apiary-mock.com/navigation";
    public static final String BANNERS                  = "https://private-3ea2b7-vamsi6.apiary-mock.com/categories";
