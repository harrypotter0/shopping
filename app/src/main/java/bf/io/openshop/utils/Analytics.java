...
public class Analytics {
     ...
     *
     * @param location    shop with app specific Google Ua or null, if global tracker is enough.
     * @param context application context.
     */
    public static synchronized void prepareTrackersAndFbLogger(Location location, Context context) {
        ...
        if (location == null) {
            ...
            if (!mTrackers.containsKey(TRACKER_APP) && analytics != null) {
                if (location.getName() != null && !location.getName().isEmpty()) {
                    Timber.d("Set new app tracker with id: %s", location.getName());
                    // App tracker determined by shop
                    Tracker appTracker = analytics.newTracker(location.getName());
     ...
     */
    public static void logShopChange(Shop actualNonNullShop, Location newShopSelected) {
