...
import bf.io.openshop.ux.fragments.HomeFragment;
...
//        }
        ...
        Analytics.prepareTrackersAndFbLogger(SettingsMy.getActualNonNullLocation(this), getApplicationContext());
    ...
    private void getCartCount(boolean initialize) {
        ...
        if (cartCountView != null) {
            ...
            if (user == null) {
                ...
                if (initialize) {
                    String url = String.format(EndPoints.CART, 21);
                    ...
                    String url = String.format(EndPoints.CART_INFO, 21/*SettingsMy.getActualNonNullShop(this).getId()*/);
