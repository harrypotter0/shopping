...
public class AccountEditFragment extends Fragment {
    ...
    private void putUser(User user) {
        if (isRequiredFields()) {
            ...
            if (activeUser != null) {
                ...
                String url = String.format(EndPoints.USER_SINGLE, 21/*SettingsMy.getActualNonNullShop(getActivity()).getId()*/, activeUser.getId());
    ...
    private void changePassword() {
        if (isRequiredPasswordFields()) {
            ...
            if (user != null) {
                String url = String.format(EndPoints.USER_CHANGE_PASSWORD, 21/*SettingsMy.getActualNonNullShop(getActivity()).getId()*/, user.getId());
