...
//                toolbar.setAlpha(1 - slideOffset / 2);
    ...
    private void getDrawerItems() {
        ...
        Log.e("DrawerFrag","getDrawerItems"+drawerLoading);
        drawerLoading = true;
        drawerProgress.setVisibility(View.VISIBLE);
        drawerRetryBtn.setVisibility(View.GONE);

        drawerRecyclerAdapter.addDrawerItem(new DrawerItemCategory(BANNERS_ID, BANNERS_ID, /*getString(R.string.Home)*/"Categories"));
        drawerRecyclerAdapter.addDrawerItem(new DrawerItemCategory(BANNERS_ID, BANNERS_ID, /*getString(R.string.Home)*/"My Orders"));
