...
//                    Timber.e("scrollY:" + scrollY + ". Alpha:" + alphaRatio);
    ...
    private void getProduct(final long productId) {
        // Load product info
        String url = String.format(EndPoints.PRODUCTS_SINGLE_RELATED, 21/*SettingsMy.getActualNonNullShop(getActivity()).getId()*/, productId);
    ...
    private void getWishListInfo(long productId) {
        ...
        if (user != null) {
            // determine if product is in wishlist
            String wishlistUrl = String.format(EndPoints.WISHLIST_IS_IN_WISHLIST, 21/*SettingsMy.getActualNonNullShop(getActivity()).getId()*/, productId);
    ...
    private void postProductToCart() {
        ...
        if (user != null) {
            ...
            String url = String.format(EndPoints.CART, 21/*SettingsMy.getActualNonNullShop(getActivity()).getId()*/);
